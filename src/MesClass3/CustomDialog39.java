...
public class CustomDialog39 extends JDialog {
    ...
    JLabel labeltable = new JLabel("Saisissez un nombre de lignes");
    JTextField inputtable = new JTextField("");


    public CustomDialog39(Frame owner, String titre, Boolean modal) {
