...
public class CustomDialog42 extends JDialog {
    ...
    JLabel labelsaisie = new JLabel("Saisissez votre lettre en minuscule");
    JTextField inputsaisie = new JTextField("");


    public CustomDialog42(Frame owner, String titre, Boolean modal) {
        ...
        btnOK.addActionListener(e -> {
            ...
            if (valeur) {
                output.append("la lettre " + inputlettre + " existe" + "\n");
            } else output.append("la lettre " + inputlettre + " n'existe pas" + "\n");
