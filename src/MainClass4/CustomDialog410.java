...
public class CustomDialog410 extends JDialog {
    ...
    JLabel labelsaisie = new JLabel("Encore de jolies etoiles");
    JTextField inputsaisie = new JTextField("");


    public CustomDialog410(Frame owner, String titre, Boolean modal) {
